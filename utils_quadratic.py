...
class incent:
    def __init__(self, Q1, Q2, A1, A2, x0_d, x1_d, u_d, d, delta,u_init, eta_init, gamma_init, MAXINNER, MAXOUTER, burn_in):
        self.d = d
        self.delta = delta
        self.x0_d = x0_d
        self.x1_d = x1_d
    ...
    def runIncentRGM(self, u0,x0, eta=0.005, var=0.001, MAXOUTER=6000,MAXINNER=500,tag='BR', BRFLAG=False, lam=1/2):
        us=[u0]
        #print(us[-1])
        self.lam=lam
...
class quadratic:
    ...
    def runSGDPlay(self,x0,u, var=0.00001, eta=0.001, MAXINNER=None):
        """
